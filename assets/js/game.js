    ...
    if (promptFight === "skip" || promptFight === "SKIP") {
      ...
      if (confirmSkip) {
        ...
        // subtract money from  playerInfo.money for skipping
         ...
         playerInfo.money = Math.max(0,  playerInfo.money - 10);//never display a negative health or money value.
...
for (var i = 0; i < enemyInfo.length; i++) {
  ...
  if (playerInfo.health > 0) {
    ...
    pickedEnemyObj.health = randomNumber(40, 60);// 0-1的随机数 乘 21 表示有可能最低值是0，那么加上40 生命值就是40.
